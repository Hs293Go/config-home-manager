...
in {
  ...
  home.shellAliases = {
    ...
    l = "ls -CF";
    md = "mkdir -p";
    da = "mkdir -p .dtach && dtach -A .dtach/local.sock $SHELL";
    hm = "home-manager";
    hmb = "home-manager build";
    hms = "home-manager switch";
    fdh = "fd --search-path ${config.home.homeDirectory}";
    fddoc = "fd --search-path ${config.home.homeDirectory}/Documents";
    fddl = "fd --search-path ${config.home.homeDirectory}/Downloads";
    fdf = "fd -t f";
    fdd = "fd -t d";
    fdr = "fd -uI --follow";
    ffd = "fd -F";
